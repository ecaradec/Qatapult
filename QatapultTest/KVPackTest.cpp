...
//}*/
//
//static bool mem_reader(cmp_ctx_t *ctx, void *data, size_t limit) {
//    memcpy(data,ctx->buf,limit);
//    return true;
//}
//
//static size_t mem_writer(cmp_ctx_t *ctx, const void *data, size_t count) {
//    memcpy(ctx->buf,data,count);
//    uint8 *p=(uint8*)ctx->buf;
//    p+=count;
//    ctx->buf=(void*)p;
//    return count;
//}
//
//TEST(msgpack) {
//    uint8 *buff=(uint8*)malloc(1024);
//    cmp_ctx_t cmp;
//    cmp_init(&cmp, buff, mem_reader, mem_writer);
//    cmp_write_array(&cmp, 3);
//    cmp_write_str(&cmp, "AAAA", 4);
//    cmp_write_str(&cmp, "BBBB", 4);
//    cmp_write_str(&cmp, "CCCC", 4);
