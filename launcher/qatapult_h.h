...
EXTERN_C const IID IID_IPainterScript;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE drawEmphased( 
            ...
            /* [in] */ INT w,
            /* [in] */ INT h,
            /* [defaultvalue][in] */ INT flag = 1,
            /* [defaultvalue][in] */ INT from = 0) = 0;
...
#define IPainterScript_drawEmphased(This,text,highlight,x,y,w,h,flag,from)	\
    ( (This)->lpVtbl -> drawEmphased(This,text,highlight,x,y,w,h,flag,from) ) 
